...
return [
    ...
    'openapi' => [
        ...
        'generators' => [
            \App\Http\Documentation\Generators\ImsPreferredOpenApiGenerator::class,
            \App\Http\Documentation\Generators\ImsPreferredErrorResponseGenerator::class,
            \App\Http\Documentation\Generators\ImsPreferredAdditionalMetaDataGenerator::class,
        ],
    ],
