...
return [
    ...
    'exists'               => 'নির্বাচিত :attribute টি পাওয়া যায় নি।',
    ...
    'min'                  => [
        'array'   => ':Attribute অবশ্যই কমপক্ষে :min উপাদানের সমান হতে হবে।',
        'file'    => ':Attribute অবশ্যই কমপক্ষে :min কিলোবাইট এর সমান হতে হবে।',
        'numeric' => ':Attribute অবশ্যই কমপক্ষে :min এর সমান হতে হবে।',
        'string'  => ':Attribute অবশ্যই কমপক্ষে :min অক্ষর এর সমান হতে হবে।',
    ],
